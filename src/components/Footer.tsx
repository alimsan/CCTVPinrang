    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-4 sm:py-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-900">Automation</a>
                  </li>
                  <li>
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-900">Submit ticket</a>
                  </li>
                  <li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-900">Terms of service</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-900">Privacy policy</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-900">License</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-4">
          <p className="text-sm leading-6 text-gray-600">&copy; 2024 Your Company, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
